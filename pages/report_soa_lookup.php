				...
				<td>
					<table width="700" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">														
							<td width="50%" class="values">&nbsp;<a name="tenant" style="cursor:hand; color:#0033FF; text-decoration:underline" onClick="javascript:invoice('<?php echo "$tenant_code";?>','<?php echo "$tenant_name";?>');"><?php echo "$tenant_name";?></a>&nbsp;
							</td>
...
function invoice(pTenantCode,pTenantName) {
	window.opener.frmSOA.hidClientCode.value = pTenantCode;
	window.opener.frmSOA.txtClientName.value = pTenantName;
	window.close();
}
