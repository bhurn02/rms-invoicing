...
<form id="frmSecDepositDetailList" name"frmSecDepositDetailList" method="post">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">TENANT SECURITY DEPOSIT - FIND
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 ...
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('tenant_deposit_detail.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="600" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						<tr bgcolor="<?php echo "$rowColor"; ?>">							
							...
							<td width="20%" class="values">&nbsp;<a href="tenant_deposit_detail.php?menu_id=<?php echo $menu_id;?>&or_no=<?php echo "$or_no";?>&mode=FIND"><?php echo "$or_no";?></a>&nbsp;
							</td>
...
function cmdDelete_OnClick() {
	if (confirm("Are you sure you want to delete this record/s?")) {
		frmSecDepositDetailList.hidMode.value = "DELETE";
		frmSecDepositDetailList.submit();
	}
}
