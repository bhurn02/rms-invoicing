...
function tenant(pTenantCode,pTenantName) {
	window.opener.frmAdvancePaymentHdr.hidClientCode.value = pTenantCode;
	window.opener.frmAdvancePaymentHdr.hidClientName.value = pTenantName;
	window.opener.frmAdvancePaymentHdr.txtClientName.value = pTenantName;
	window.close();
}
