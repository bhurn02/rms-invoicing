...
if ($strMode != "") {
	...
	switch ($strMode) {
		case "PRINT":
			...
			$sqlquery="sp_rpt_Invoice_Listing '" . $strCondition . "','" . $strSortBy . "','" . $strGroupBy . "'";	
			//echo $sqlquery;
			//exit();
			...
			$my_report = $report_path . "t_invoice_listing.rpt"; // 
			//echo $my_report;
			//die();
			//rpt source file 
			$pdf_file = "t_invoice_listing" . str_replace("/","",date("m/d/y/H/i/s", time())) . ".pdf";
...
$sqlqueryCharges="SELECT * FROM rg_table_fields where module_id=8 order by xorder";	
...
<form name="frmUnitCharges" id="frmUnitCharges" method="post" action="report_invoice_listing_customized.php?menu_id=<?php echo $menu_id;?>">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">INVOICE LIST REPORT
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr valign="top">
						<td>					
							<table width="500" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
								<tr height="30">							
									<td width="36%" class="tablehdr" align="center">&nbsp;Set Filter To&nbsp;
									</td>
									<td  width="16%" class="tablehdr" align="center">&nbsp;Condition&nbsp;
									</td>
									<td  width="48%" class="tablehdr" align="center">&nbsp;Value&nbsp;
									</td>							
								</tr>
								<?php
								$ctr = 0;
								...
								<tr id="editRow<?php echo "$ctr";?>" name="editRow<?php echo "$ctr";?>" style="cursor:hand" bgcolor="<?php echo "$rowColor" ?>">							
									<td width="36%" style="border:1px" class="values">&nbsp;<?php echo "$field_desc";?>&nbsp;
									<input type="hidden" id="hidCondition<?php echo "$ctr";?>" name="hidCondition<?php echo "$ctr";?>" value="<?php echo $field_name;?>">
									</td>
									<td width="16%" style="border:1px" class="values" align="center">
									...
									<td width="48%" style="border:1px" class="values" align="center">
