...
<form id="frmInvoiceReportLookup" name"frmInvoiceReportLookup" method="post">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">INVOICE LOOKUP
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			 
				...
				<td>
					<table width="650" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">														
							<td width="21%" class="values">&nbsp;<a name="invoice_no" style="cursor:hand; color:#0033FF; text-decoration:underline" onClick="javascript:invoice('<?php echo "$invoice_no";?>','<?php echo "$invoice_no";?>');"><?php echo "$invoice_no";?></a>&nbsp;
							</td>
...
function cmdSearch_OnClick() {
	frmInvoiceReportLookup.submit();
}

function invoice(pInvoiceNo) {
	window.opener.frmInvoiceReport.txtInvoiceNoFrom.value = pInvoiceNo;
	window.close();
}
