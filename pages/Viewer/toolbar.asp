...
<form method="POST" name="pf" target="CrystalViewerPageFrame" action="../lib/Viewer/rptserver.asp?cmd=srch&viewer=html_frame&vfmt=html_frame&page=<%response.write CurrentPageNumber %>&dir=FOR&case=0<% response.write brch%>">
