...
<title></title>
<frameset cols="15%,*">
<frame name="CrystalViewerTree" src="../lib/Viewer/rptserver.asp?cmd=get_ttl&viewer=html_frame&vfmt=html_frame<% response.write qs %>">
<frame name="CrystalViewerPageFrame" src="../lib/Viewer/rptserver.asp?cmd=toolbar_page&viewer=html_frame&vfmt=html_frame&page=<% response.write session("CurrentPageNumber") %><% response.write qs %>">
