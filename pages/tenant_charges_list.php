...
//echo $sqlquerycbo;
$sqlquery="exec sp_m_Tenant_List '','" . $strSearchList . "','" . $strKeyword . "'";
$process=odbc_exec($sqlconnect, $sqlquery);
//echo $sqlquery;
...
<form id="frmTenantChargesList" name"frmTenantChargesList" method="post" action="tenant_charges_list.php?menu_id=<?php echo $menu_id;?>">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">TENANT - FIND
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			 
			 </a></li>	
			 <li class="li_nc"><a href="#" onClick="javascript:cmdSearch_OnClick();">|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('tenant_charges.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="1000" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						<tr height="30">													
							...
							<td width="21%" class="tablehdr" align="center">&nbsp;Name&nbsp;
							</td>							
							<td width="9%" class="tablehdr" align="center">Real Property Code
							</td>					
							<td width="8%" class="tablehdr" align="center">Building Code
							</td>					
							<td width="6%" class="tablehdr" align="center">Unit No.
							</td>					
							<td width="11%" class="tablehdr" align="center">&nbsp;Type&nbsp;
							</td>												
							<td width="22%" class="tablehdr" align="center">&nbsp;Bill To&nbsp;
							</td>			
							<td width="9%" class="tablehdr" align="center">&nbsp;Is Terminated?&nbsp;
							</td>						
						</tr>
						<?php
						while(odbc_fetch_row($process)){
							$code = trim(odbc_result($process,"tenant_code")); 
							$name = odbc_result($process,"tenant_name"); 
							$tenant_type_desc = odbc_result($process,"tenant_type_desc"); 
							$bill_to = odbc_result($process,"bill_to_name"); 
							$real_property_code = odbc_result($process,"real_property_code"); 
							$building_code = odbc_result($process,"building_code"); 
							$terminated = odbc_result($process,"is_terminated"); 
							$unit_no = odbc_result($process,"unit_no"); 
							$unit = $real_property_code . "/" . $building_code . "/" . $unit_no;
							if ($unit == "//") {
								$unit = "";
							}
							$ctr = $ctr+1;
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">														
							<td width="10%" class="values">&nbsp;<a href="tenant_charges.php?menu_id=<?php echo $menu_id;?>&code=<?php echo "$code";?>&name=<?php echo "$name";?>&mode=FIND"><?php echo "$code";?></a>&nbsp;
							</td>
							<td width="21%" class="values">&nbsp;<?php echo "$name";?>
							</td>			
							<td width="9%" class="values">&nbsp;<?php echo "$real_property_code";?>&nbsp;
							</td>					
							<td width="8%" class="values">&nbsp;<?php echo "$building_code";?>&nbsp;
							</td>					
							<td width="6%" class="values">&nbsp;<?php echo "$unit_no";?>&nbsp;
							</td>					
							<td width="11%" class="values">&nbsp;<?php echo "$tenant_type_desc";?>
							</td>					
							<td width="22%" class="values">&nbsp;<?php echo "$bill_to";?>
							</td>	
							<td width="9%" class="values">&nbsp;<?php echo "$terminated";?>
							</td>				
						</tr>
