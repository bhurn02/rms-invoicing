...
<form id="frmChargesList" name"frmChargesList" method="post" action="tenant_list.php?menu_id=<?php echo $menu_id;?>">
	<div class="mainmenu">	
		<ul>
			 ...
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('tenant.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="1000" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">							
							...
							<td width="10%" class="values">&nbsp;<a href="tenant.php?menu_id=<?php echo $menu_id;?>&code=<?php echo "$code";?>&mode=FIND"><?php echo "$code";?></a>&nbsp;
							</td>
