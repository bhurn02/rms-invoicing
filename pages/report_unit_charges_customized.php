...
if ($strMode != "") {
	...
	switch ($strMode) {
		case "PRINT":
			...
			$my_report = $report_path . "m_unit_charges.rpt"; // 
			//echo $my_report;
			//die();
			//rpt source file 
			$pdf_file = "m_unit_charges" . str_replace("/","",date("m/d/y/H/i/s", time())) . ".pdf";
...
$sqlqueryCharges="SELECT * FROM rg_table_fields where module_id=3 order by xorder";	
...
<html> 
<head> 
<title>UNIT CHARGES LIST REPORT</title> 
...
<form name="frmUnitCharges" id="frmUnitCharges" method="post" action="report_unit_charges_customized.php?menu_id=<?php echo $menu_id;?>">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">UNIT CHARGES LIST REPORT
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
