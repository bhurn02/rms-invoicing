...
if ($strUnitSearch =="V")
	$sqlquery="exec sp_t_Security_Deposit_Detail 'VACANT_UNITS','" . $strORNo . "',0,'','','',0,'" . $strKeyword . "','','',''";
elseif ($strUnitSearch =="O")
	$sqlquery="exec sp_t_Security_Deposit_Detail 'OCCUPIED_UNITS','" . $strORNo . "',0,'','','',0,'" . $strKeyword . "','','',''";
else
	$sqlquery="exec sp_t_Security_Deposit_Detail 'ALL_UNITS','" . $strORNo . "',0,'','','',0,'" . $strKeyword . "','','',''";
...
<form id="frmRealPropertyList" name"frmRealPropertyList" method="post">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">UNIT - LOOKUP
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
function tenant(pRealPropertyCode,pRealPropertyName,pBldgCode,pUnitNo) {
	window.opener.frmTenantDepositDtl.hidAddRealPropertyCode.value = pRealPropertyCode;
	window.opener.frmTenantDepositDtl.hidAddBuildingCode.value = pBldgCode;
	window.opener.frmTenantDepositDtl.hidAddUnitNo.value = pUnitNo;
	window.opener.frmTenantDepositDtl.txtAddDetail.value = pRealPropertyName + " / " + pBldgCode + " / " + pUnitNo;
	window.close();
}
