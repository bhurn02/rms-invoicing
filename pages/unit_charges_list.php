...
<form id="frmRealPropertyList" name"frmRealPropertyList" method="post">
	<div class="mainmenu">	
		<ul>
			 ...
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('unit_charges.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="500" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						while(odbc_fetch_row($process)){
							...
							$building_code = replacedoublequotes(odbc_result($process,"building_code")); 
							$real_property_code = replacedoublequotes(odbc_result($process,"real_property_code")); 
							$real_property_name = replacedoublequotes(odbc_result($process,"real_property_name")); 
							$ctr = $ctr+1;
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">							
							...
							<td width="55%" class="values">&nbsp;<a href="unit_charges.php?menu_id=<?php echo $menu_id;?>&real_property_code=<?php echo "$real_property_code";?>&building_code=<?php echo "$building_code";?>&unit_no=<?php echo "$unit_no";?>&mode=FIND"><?php echo "$real_property_name";?></a>&nbsp;
							</td>
