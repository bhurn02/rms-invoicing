 ...
 * 	- Clicking the label will now toggle the checkbox.
 */
	...
	switch ($strMode) {
		...
		case "RETRIEVE" || "FIND":
			...
			if (odbc_fetch_row($process)) {
					...
					$blnComplimentary = odbc_result($process,"is_complimentary");	
							...
							<td>
								<table>
									...
									<tr>
										...
										<td width="20"></td>
										<td class="values"><input name="chkReserved" id="chkReserved" type="checkbox" <?php echo $blnReserved;?>><label for="chkReserved">RESERVED</label></td>
									</tr>	
									<tr>
										<td class="fieldname">&nbsp;</td>
										<td width="20"></td>
										<td class="values"><input name="chkComplimentary" id="chkComplimentary" type="checkbox" <?php echo ($blnComplimentary)?'checked':'';?>><label for="chkComplimentary">COMPLIMENTARY</label></td>
									</tr>	
								</table>
							</td>
						</tr>
