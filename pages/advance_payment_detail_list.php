...
if ($strMode == "VOID") {
	...
	while ($i <= $_POST["hidRowCtr"]) {
		if (isset($_POST["chkSelect" . strval($i)])) {
			$sqlquery="exec sp_t_Payment_Header 'VOID','" . $_POST["hidCode" . $i] . "','','',0,'','','','','',''";
			//echo $sqlquery;
...
elseif ($strMode == "DELETE") {
	...
	while ($i <= $_POST["hidRowCtr"]) {
		if (isset($_POST["chkSelect" . strval($i)])) {
			$sqlquery="exec sp_t_Payment_Header 'DELETE','" . $_POST["hidCode" . $i] . "','','',0,'','','','','',''";
			//echo $sqlquery;
			$process=odbc_exec($sqlconnect, $sqlquery);
			if (odbc_fetch_row($process)) {
				if (odbc_result($process,"x") == 1) 
...
<form id="frmPaymentHdrList" name"frmPaymentHdrList" method="post">
	<div class="mainmenu">	
		<ul>
			  <li class="li_nc"><a name="MODULE NAME">ADVANCE PAYMENT DETAIL - FIND
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 ...
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('advance_payment_detail.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="600" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						...
						<tr bgcolor="<?php echo "$rowColor"; ?>">							
							...
							<td width="20%" class="values">&nbsp;<a href="advance_payment_detail.php?menu_id=<?php echo $menu_id;?>&or_no=<?php echo "$or_no";?>&mode=FIND"><?php echo "$or_no";?></a>&nbsp;
							</td>
