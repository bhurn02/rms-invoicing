...
if ($strMode == "VOID") {
	...
	while ($i <= $_POST["hidRowCtr"]) {
		if (isset($_POST["chkSelect" . strval($i)])) {
			$sqlquery="exec sp_t_Invoice_Void 'VOID','" . $_POST["hidCode" . $i] . "','" . $sessUserID . "','" . $sessCompanyCode . "','" . $strIPAddr . "'";
			//echo $sqlquery;
...
while (odbc_fetch_row($processcbo)) {
	if (replacedoublequotes($strSearchList) == replacedoublequotes(trim(odbc_result($processcbo,"column_code")))) {
		...
		if ($strSearchList == "" && odbc_result($processcbo,"xorder") == 1)
			$strSearchList = replacesinglequote(trim(odbc_result($processcbo,"column_code")));
	}
}
...
<form id="frmChargesList" name"frmChargesList" method="post" action="invoice_list.php?menu_id=<?php echo $menu_id;?>">
	<div class="mainmenu">	
		<ul>
			 ...
			 <li class="li_nc"><a href="#" onClick="javascript:change_loc('invoice_header.php?menu_id=<?php echo $menu_id;?>')">Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a></li>	  
		</ul>
	</div>
	<table>
		<tr>
				...
				<td>
					<table width="850" style="border:1px solid #556b2f;padding: 30px 10px 5px;">
						<tr height="30">				
							...
							<td  width="15%" class="tablehdr" align="center">&nbsp;Invoice No.&nbsp;
							</td>
							<td  width="9%" class="tablehdr" align="center">&nbsp;Date&nbsp;
							</td>
							<td width="29%" class="tablehdr" align="center">&nbsp;Client&nbsp;
							</td>		
							<td width="9%" class="tablehdr" align="center">&nbsp;Status&nbsp;
							</td>	
							<td width="18%" class="tablehdr" align="center">&nbsp;Unit No.&nbsp;
							</td>				
							<td width="16%" class="tablehdr" align="center">&nbsp;Total Amount&nbsp;
							</td>				
						</tr>
						<?php
						while(odbc_fetch_row($process)){
							...
							$total_inv_amt = odbc_result($process,"total_inv_amt"); 
							$ctr = $ctr+1;
						...
						<tr bgcolor="<?php echo "$rowColor" ?>">							
							...
							<td width="15%" class="values">&nbsp;<a href="invoice_header.php?menu_id=<?php echo $menu_id;?>&invoice_no=<?php echo "$invoice_no";?>&mode=FIND"><?php echo "$invoice_no";?></a>&nbsp;
							</td>
							<td width="9%" class="values" align="center">&nbsp;<?php echo "$invoice_date";?>&nbsp;
							</td>
							<td width="29%" class="values">&nbsp;<?php echo "$tenant_name";?>&nbsp;
							</td>							
							<td width="9%" class="values">&nbsp;<?php echo "$strStatusDesc";?>&nbsp;
							</td>	
							<td width="18%" class="values">&nbsp;<?php echo "$unit_no";?>&nbsp;
							</td>							
							<td width="16%" class="values" align="right">&nbsp;$<?php echo "$total_inv_amt";?>&nbsp;
							</td>							
						</tr>
